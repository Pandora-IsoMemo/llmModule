...
## New Features
- Added `ask_llm()` convenience wrapper that routes API construction, prompt config, and dispatch in one call (#17).
...
## Updates
- Added Export of `is_ollama_running` function for extraction of shiny modules into a separate package (#12)
